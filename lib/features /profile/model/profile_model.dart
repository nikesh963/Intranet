...
class Employee {
  ...
  String? setTempalte;
  int? setHubstufftime;
  DateTime? prevApprisalDate;
  int? allowedApprisalPeriodLeaves;
  ...
  factory Employee.fromJson(Map<String, dynamic> json) => Employee(
    ...
    prevApprisalDate: json["prev_apprisal_date"] == null ? null : DateTime.parse(json["prev_apprisal_date"]),
    allowedApprisalPeriodLeaves: json["allowed_apprisal_period_leaves"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "prev_apprisal_date": "${prevApprisalDate!.year.toString().padLeft(4, '0')}-${prevApprisalDate!.month.toString().padLeft(2, '0')}-${prevApprisalDate!.day.toString().padLeft(2, '0')}",
