...
class AppColors {
  // -- Primary
  final primary = const Color(0xff272262);

  // -- secondary
  final secondaryLight = const Color(0xffE9ECFF);
  final secondaryMedium = const Color(0xffE8ECFF);
  final secondaryDark = const Color(0xff587DFF);
  ...
  final blue = const Color(0xFF1D61E7);
}
